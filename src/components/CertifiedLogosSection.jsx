...
export default function CertifiedLogosSection() {
  ...
  return (
    <section className="bg-[#120c1a] py-12 border-y border-white/[0.04] relative overflow-hidden z-30">
      {/* Background Side Glows - Custom Brand Tones */}
      <div className="absolute top-0 left-0 w-full h-full pointer-events-none opacity-40">
        <div className="absolute top-1/2 left-0 -translate-y-1/2 w-72 h-32 bg-[#4B1B67]/15 blur-3xl" />
        <div className="absolute top-1/2 right-0 -translate-y-1/2 w-72 h-32 bg-[#A35C37]/10 blur-3xl" />
      </div>
      ...
      <div className="max-w-7xl mx-auto px-6 md:px-12 mb-10 flex flex-col md:flex-row md:items-center justify-between gap-4 relative z-10 animate-[fadeUp_0.7s_ease-out_both]">
        <div className="text-left max-w-sm">
          <span className="text-[10px] font-black tracking-[0.3em] text-[#A35C37] uppercase block mb-1">
            Vetted Excellence
          </span>
          <h3 className="text-sm font-bold text-slate-400 uppercase tracking-wider">
            Approved Regulatory Compliance
        ...
        <div className="flex items-center gap-2 bg-white/[0.03] border border-white/5 rounded-full px-4 py-1.5 self-start md:self-auto backdrop-blur-sm">
      ...
      <div className="relative w-full overflow-hidden flex items-center py-2 before:content-[''] before:absolute before:left-0 before:top-0 before:w-32 before:h-full before:bg-gradient-to-r before:from-[#120c1a] before:to-transparent before:z-20 after:content-[''] after:absolute after:right-0 after:top-0 after:w-32 after:h-full after:bg-gradient-to-l after:from-[#120c1a] after:to-transparent after:z-20">
          ...
          {infiniteScrollData.map((cert, index) => {
            ...
            return (
              <div
                ...
                className="flex items-center gap-4 select-none cursor-default group shrink-0"
              >
                {/* Icon Container with hover brand colors */}
                <div className="w-10 h-10 rounded-xl bg-white/[0.02] border border-white/10 flex items-center justify-center group-hover:border-[#4B1B67]/40 group-hover:bg-[#4B1B67]/10 transition-colors duration-200 shadow-inner">
                  <IconComponent
                    className="w-5 h-5 text-slate-400 group-hover:text-[#A35C37] transition-colors duration-200"
                    strokeWidth={1.8}
                  />
                </div>
                ...
                <div className="flex flex-col text-left">
                  <div className="flex items-center gap-2.5">
                    <h4 className="text-base font-black tracking-widest text-white transition-colors duration-200 group-hover:text-[#A35C37] uppercase">
                      {cert.name}
                    </h4>

                    <span className="text-white/10 group-hover:text-[#4B1B67]/40 text-xs transition-colors duration-200">
                      ✦
                    </span>
                  </div>

                  <span className="text-[10px] font-bold text-slate-500 uppercase tracking-widest block group-hover:text-slate-300 transition-colors duration-200 mt-0.5">
                    {cert.label}
                  </span>
                </div>
              </div>
